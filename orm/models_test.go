...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/florin-rada/beego/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/florin-rada/beego/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/florin-rada/beego/orm
	...
	go test -v github.com/florin-rada/beego/orm
